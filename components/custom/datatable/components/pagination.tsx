  ...
  return (
    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between px-2 gap-4 py-2">
      <div className="text-sm">
        ...
        <span className="font-medium">{totalDocs && totalDocs > 0 ? totalDocs : 0}</span>
      </div>
      <div className="flex flex-wrap items-center gap-4 w-full sm:w-auto">
        ...
        <div className="flex items-center gap-2">
          <Button variant="outline" className="h-8 w-8 p-0 sm:flex" onClick={() => table.setPageIndex(0)} disabled={!table.getCanPreviousPage()}>
          ...
          <Button variant="outline" className="h-8 w-8 p-0 sm:flex" onClick={() => table.setPageIndex(table.getPageCount() - 1)} disabled={!table.getCanNextPage()}>
